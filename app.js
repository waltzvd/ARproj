...
import { RGBELoader } from '/ARproj/libs/three128/jsm/RGBELoader.js';
import { ARButton } from '/ARproj/libs/ARButton.js';
import { LoadingBar } from '/ARproj/libs/LoadingBar.js';
import { Player } from '/ARproj/libs/Player.js';
...
class App{
    ...
    setEnvironment(){
        ...
        loader.load( '/ARproj/assets/hdr/venice_sunset_1k.hdr', ( texture ) => {
